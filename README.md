...
Setup new git Repository command:
1)git clone https://nilavpatel.visualstudio.com/_git/Ng-App
2)pass your credential

Setup new package.config file:
1) go to folder in command console
2) npm init
